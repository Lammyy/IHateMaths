...
#with tf.Session() as sess:
    ...
    np.savetxt("JCKLexp truklavg.csv", KLAVGBRUH, delimiter=",")
    np.savetxt("JCKLexp estimatorloss.csv", ISTHISLOSS, delimiter=",")
    np.savetxt("JCKLexp nelbo.csv", NELBRUH, delimiter=",")
    np.savetxt("JCKLexp converge.csv", converge)
    plt.plot(KLAVGBRUH)
    plt.axvline(x=(converge[0]/100), ls='--')
    plt.xlabel('Iterations (x100)')
    plt.ylabel('Avg KL Div')
    plt.savefig("JCKLexp truklavg")
    plt.close()
    plt.plot(ISTHISLOSS)
    plt.axvline(x=converge[0], ls='--')
    plt.xlabel('Iterations')
    plt.ylabel('Estimator Loss')
    plt.savefig("JCKLexp estimatorloss")
    plt.close()
    plt.plot(NELBRUH)
    plt.axvline(x=converge[0], ls='--')
    plt.xlabel('Iterations')
    plt.ylabel('NELBO')
    plt.savefig('JCKLexp nelbo')
    plt.close()
    #nice plot
