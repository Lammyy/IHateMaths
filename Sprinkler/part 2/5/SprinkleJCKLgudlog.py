...
#with tf.Session() as sess:
    ...
    np.savetxt("JCKLgudlog truklavg.csv", KLAVGBRUH, delimiter=",")
    np.savetxt("JCKLgudlog estimatorloss.csv", ISTHISLOSS, delimiter=",")
    np.savetxt("JCKLgudlog nelbo.csv", NELBRUH, delimiter=",")
    np.savetxt("JCKLgudlog converge.csv", converge)
    plt.plot(KLAVGBRUH)
    plt.axvline(x=(converge[0]/100), ls='--')
    plt.xlabel('Iterations (x100)')
    plt.ylabel('Avg KL Div')
    plt.savefig("JCKLgudlog truklavg")
    plt.close()
    plt.plot(ISTHISLOSS)
    plt.axvline(x=converge[0], ls='--')
    plt.xlabel('Iterations')
    plt.ylabel('Estimator Loss')
    plt.savefig("JCKLgudlog estimatorloss")
    plt.close()
    plt.plot(NELBRUH)
    plt.axvline(x=converge[0], ls='--')
    plt.xlabel('Iterations')
    plt.ylabel('NELBO')
    plt.savefig('JCKLgudlog nelbo')
    plt.close()
    #nice plot
    ...
    for i in range(5):
       ...
       plt.xticks([])
       plt.yticks([])
    plt.savefig('JCKLgudlog Final Fig')
    plt.close()
